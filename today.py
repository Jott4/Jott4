...
USER_NAME = os.environ.get('USER_NAME', 'Jott4')
BIRTHDAY = datetime.datetime(2002, 1, 1)
QUERY_COUNT = {'user_getter': 0, 'follower_getter': 0, 'graph_repos_stars': 0, 'recursive_loc': 0, 'graph_commits': 0, 'loc_query': 0}


def daily_readme(birthday):
    """
    Retorna quanto tempo passou desde a data de nascimento
    e.g. 'XX anos, XX meses, XX dias'
    """
    diff = relativedelta.relativedelta(datetime.datetime.today(), birthday)
    return '{} {}, {} {}, {} {}{}'.format(
        diff.years, 'ano' + format_plural(diff.years),
        diff.months, 'mes' + ('es' if diff.months != 1 else ''),
        diff.days, 'dia' + format_plural(diff.days),
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    justify_format(root, 'star_data', star_data, 3)
...
if __name__ == '__main__':
    """
    Adaptado de Andrew Grant (Andrew6rant), 2022-2025 - MIT
    """
